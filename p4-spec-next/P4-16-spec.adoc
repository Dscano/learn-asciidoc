...
<<_calling_convention_call_by_copy_incopy_out>>).
...
<<_calling_convention_call_by_copy_incopy_out>> for more details on directionless
parameters.
...
The calling convention is copy-in/copy-out (<<_calling_convention_call_by_copy_incopy_out>>).  For generic functions the type arguments
...
same way as described for direction `out` parameters in <<_calling_convention_call_by_copy_incopy_out>>). The language places few restrictions on
...
<<_calling_convention_call_by_copy_incopy_out>> for details on copy-out behavior.
...
performed after the execution of the `exit` statement.  See <<_calling_convention_call_by_copy_incopy_out>> for details on copy-out behavior.
...
ways (subject to a few limitations -- see <<_calling_convention_call_by_copy_incopy_out>>).  Since externs are
...
* Clarified restrictions for parameters with default values (<<_calling_convention_call_by_copy_incopy_out>>).
...
* Clarified semantics of directionless parameters (<<_calling_convention_call_by_copy_incopy_out>>).
...
* Clarified restrictions on extern method and function invocation (<<_appendix_restrictions_on_compile_time_and_run_time_calls>>).
...
* Added `@pure` and `@noSideEffects` annotations (<<_extern_functionmethod_annotations>>).
...
* Clarified initialization semantics (<<_l_values>> and
  <<_calling_convention_call_by_copy_incopy_out>>), especially for headers and local
  variables.
...
* Optional and named parameters (<<_calling_convention_call_by_copy_incopy_out>>)
...
* Calling restrictions (<<_appendix_restrictions_on_compile_time_and_run_time_calls>>)
...
//| `pure`        | pure function                                      | <<_extern_functionmethod_annotations>> |
//| `noSideEffects` | function with no side effects                    | <<_extern_functionmethod_annotations>> |
...
called.  See <<_calling_convention_call_by_copy_incopy_out>>.
